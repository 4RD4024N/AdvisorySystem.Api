...
## ⚠️ ÖNEMLİ: ADVISOR ATAMA SİSTEMİ

Bu sistemde **öğrenci-advisor ilişkisi Admin tarafından yönetilir**:

- ❌ Öğrenciler advisor'a istek **gönderemez**
- ❌ Öğrenciler advisor **seçemez**
- ❌ **Request/approval** mekanizması **yok**
- ✅ **Sadece Admin** advisor atar/kaldırır
- ✅ Atama anında bildirimler gönderilir
- ✅ Öğrenciler atanan advisor'ı görür (`/api/advisors/my-advisor`)
- ✅ Advisor'lar kendilerine atanan öğrencileri görür (`/api/students/my-students`)
